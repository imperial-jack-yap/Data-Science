...
Similar to the derivation for (@eq-xi-zero), we let $a$ be the realisation of the uniform distribution, A. 
$$
...
for (id in ids){
  ...
  qqplot(theoretical_q, actual_q, xlab = "Theoretical Quantiles", ylab = "Actual Quantiles", 
